          ...
          <div className="flex justify-between mt-3">
              <button
                className="rounded-[10.5px] bg-gradient-to-b from-[#4204ff] to-[#2e9cfe] px-4 py-2 border-t border-[#3D4AFF] flex gap-x-1">
                  <InvestSVG />
                  <p
                    className="font-proxima font-bold text-[13.75px] leading-[110%] tracking-[-2%] items-center">Инвестировать</p>
              </button>
              <button
                className="rounded-[10.5px] bg-gradient-to-b from-[#181921] to-[#181A22] px-4 py-2 border-t border-[#0F1014] flex items-center gap-x-1">
                  <CollectSVG />
