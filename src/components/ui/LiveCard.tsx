        ...
        <div className="flex justify-between items-center w-full">
            <div className="flex">
                ...
                <div className="flex flex-col ml-2 justify-center gap-y-[4px]">
                    ...
                    <p className="font-proxima text-[#44FF84] text-[16px] leading-[110%] tracking-[-2%] font-bold">
                        {action}
                    </p>
                </div>
            </div>
            <div className="flex flex-col items-end gap-y-[4px]">
                ...
                <p className="font-proxima text-white text-[11.72px] leading-[12.89px] tracking-[-2%] font-normal opacity-50">
                    {time}
                </p>
            </div>
        </div>
