        ...
        >
            ...
            <div className="mx-4 mt-4">
                <p className="font-proxima text-[12px] leading-[15px] text-left text-[#C1C1C1]">
                    Страховой фонд компании Revero формируется из процентов дохода наших инвесторов, также из личного
                    дохода платформы. Мы часто привлекаем различных спонсоров в нашу платформу которые также имеют
                    огромный вклад в наш страховой фонд. В случае любых случайных происшествий мы распределим страховой
                    фонд между всеми участниками нашей компании что гарантирует полную безопасность средств наших
                    вкладчиков.
                </p>
            </div>
        </motion.div>
